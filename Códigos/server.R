...
shinyServer(function(input, output){
  ...
  output$atributos <- renderUI({
    ...
    #Retira espaços do nome da classe
    ...
    return(
      div(h3("Selecionar Variáveis"),
        div(
          h5(strong("Por favor, desmarque o atributo que será a 'Classe' na coluna da esquerda e marque-o na da direita: ")),
  ...
  output$rede_neural <- DT::renderDataTable({
    ...
    if(input$inicio > 0){
      withProgress(message="Processando o Arquivo!", value=0.1, {
        ...
        #Normalização do dataset. Valores ficam na dimensão entre 0 e 1
        ...
        #APlicando a Rede Neural já com a classe "Temperatura"  
        NN = neuralnet(
